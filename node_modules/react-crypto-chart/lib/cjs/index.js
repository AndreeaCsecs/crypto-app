...
var TradeViewChart = function (_a) {
    ...
    var _h = (0, react_1.useState)(null), updatedata = _h[0], setUpdateData = _h[1];
    var fetchCandleData = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        var candleData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, fetchService_1.fetchCandleStickData)(pair)];
                case 1:
                    candleData = _a.sent();
    ...
    (0, react_1.useEffect)(function () {
        var ws = new WebSocket("".concat(constants_1.WS_URL, "/").concat(pair.toLocaleLowerCase(), "@kline_").concat(interval));
